    ...
    <div class="container">
      <div class="columns">
        <div class="column is-offset-2">
          <h2><center>KMUTNB GRADE CALCULATOR</center></h2><br>
      ...
      <div class="columns">
        <div class="column is-offset-2 is-3">
            <div class="field">
              <label class="label"><center>เกรดเฉลี่ยสะสม</center></label>
              <p class="control">
                <center><input class="input" type="text" placeholder="GPA"></center>
              </p>
            </div>
        </div>
        <div class="column">
          <br>
          <center><a   class="button is-info is-small" @click="createTb(subject)">ตกลง</a></center><br><br><br>
          <table v-if="showtb"  class="table is-striped is-narrow">
            <thead>
              <th>#</th><center><th>ชื่อวิชา</th><th>หน่วยกิต</th><th>เกรด</th></center>
            </thead>
            <tr>
              <td>1</td>
